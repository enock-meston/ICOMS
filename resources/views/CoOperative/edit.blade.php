            ...
            <div class="col-md-12 col-xxl-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <form method="POST" action="{{ route('cooperative.user.update', $user->id) }}" id="userForm" aria-multiselectable="">
                            @csrf
                            @method('PUT')
                                ...
                                <div class=" col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="full_name" class="form-control" id="userName"
                                            placeholder="....." value="{{ old('full_name', $user->full_name) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row g-3row g-3">
                                <div class=" col-md-6 mb-3">
                                    <label for="userPhone" class="form-label">Nimero ya Telephone <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" name="phone" class="form-control" id="userPhone"
                                            placeholder="....." value="{{ old('phone', $user->phone) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class=" col-md-6 mb-3">
                                    <label for="userUsername" class="form-label">Username <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" name="username" class="form-control" id="userUsername"
                            ...
                            <div class="row g-3row g-3">
                                <div class="col-md-6 mb-3">
                                    <label for="userDepartment" class="form-label">Department <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="userRoles" class="form-label">Role/Umurimo <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                            ...
                            <div class="row g-3row g-3">
                                <div class="col-md-6 mb-3" data-password="bar">
                                    <label for="userPassword" class="form-label" id="passwordLabel">Password <span
                                            class="text-muted">(Leave blank to keep current password)</span></label>
                                    <div class="input-group">
