            ...
            <div class="col-lg-12">
                <form class="card border p-3">
                    <div class="row gap-3">
                        ...
                        <div class="col">
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                <a href="{{ route('cooperative.user.create') }}" class="btn btn-sm btn-primary btn-add-user">andika Undi Mukozi</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                <a href="users-profile.html" class="link-reset">{{ $user->full_name }}</a>
                            </h5>
                            <!-- Designation & Badge -->
                            ...
                            <!-- Buttons -->
                            <div class="mt-3">
                                <a href="{{ route('cooperative.user.edit', $user->id) }}" class="btn btn-outline-secondary btn-sm me-1">
                                    Edit
                                </a>
                                <form method="POST" action="{{ route('cooperative.user.destroy', $user->id) }}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
