...
@section('content')
                ...
                <div class="card border p-3">
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        <button type="button" onclick="setAction('INSERT')" data-bs-toggle="modal"
                            ...
                            class="btn btn-sm btn-primary">Record Member Payment
                        </button>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="memberPaymentModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="memberPaymentModalTitle">Record Member Payment</h4>
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Rice Delivery</label>
                        ...
                        <div class="mt-3 d-grid">
                            <button type="button" id="memberPaymentMainActionBtn" class="btn btn-primary" onclick="alert('Action placeholder')">Record Payment</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        function setAction(action, el = null) {
            ...
            const form = document.querySelector('#memberPaymentModal form');
