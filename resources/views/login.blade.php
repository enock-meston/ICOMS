                ...
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <div class="auth-brand text-center mb-2">
                            <a class="logo-dark">
                                <img src="assets/images/logo-black.png" alt="dark logo" height="48" width="150">
                            </a>

                            <p class="text-muted w-lg-75 mt-3 mx-auto">Tagira gukoresha System Winjiza email na Password</p>
                        </div>
                        <div class="row">
            <div class="col-lg-12">
                @if (session('success'))
                        ...
                        <form action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="form-check">
                                        <input class="form-check-input form-check-input-light fs-14" type="checkbox" name="isCoperativeUser" id="isCoperativeUser" value="1">
                                        <label class="form-check-label" for="isCoperativeUser">Ndi Muri koperative</label>
                                    </div>
                                <a href="auth-reset-pass.html" class="text-decoration-underline link-offset-3 text-muted">Wibagiwe Password?</a>
                            </div>

                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary fw-semibold py-2">Injira</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- Mirrored from coderthemes.com/ubold/html/auth-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Dec 2025 08:13:48 GMT -->
</html>
