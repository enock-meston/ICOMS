...
<body>
    ...
    <div class="auth-box overflow-hidden align-items-center d-flex bg-dark">
        <div class="container">
                ...
                <div class="col-xxl-6 col-md-6 col-sm-8">
                    <div class="card p-4">
                        ...
                        <div class="auth-brand text-center mb-2">
                            ...
                            <p class="text-muted w-lg-75 mt-3 mx-auto">Tagira gukoresha System Winjiza email na Password
                            </p>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name="email" id="userEmail"
                                        value="enock@example.com" required>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="form-check">
                                    <input class="form-check-input form-check-input-light fs-14" type="checkbox"
                                        name="isCoperativeUser" id="isCoperativeUser" value="1">
                                    <label class="form-check-label" for="isCoperativeUser">Ndi Muri koperative</label>
                                </div>
                                <a href="auth-reset-pass.html"
                                    class="text-decoration-underline link-offset-3 text-muted">Wibagiwe Password?</a>
                            </div>

                            <div class="d-grid">
                                <button type="submit" class="btn btn-dark fw-semibold py-2">Injira</button>
                            </div>
                        </form>
                    </div>
                </div>
