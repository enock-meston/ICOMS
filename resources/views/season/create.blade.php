            ...
            <div class="col-md-12 col-xxl-3">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <form method="POST" action="{{ route('season.store') }}" id="userForm" aria-multiselectable="">
                            @csrf
                            <div class="row g-3row g-3">
                                ...
                                <div class=" col-md-6 mb-3">
                                    <label for="userName" class="form-label">Imimerere <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                            ...
                            <div class="row g-3row g-3">
                                <div class=" col-md-6 mb-3">
                                    <label for="userName" class="form-label">Gutangira <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="date" name="Start_Date" class="form-control" id="userName"
                                             required>
                                    </div>
                                </div>

                                <div class=" col-md-6 mb-3">
                                    <label for="userName" class="form-label">kurangira <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
